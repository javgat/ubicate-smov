...
public class UserSuggestionProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "es.uva.ubicate.ui.search.UserSuggestionProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (users == null || users.isEmpty()){
            ...
            Request request = new Request.Builder()
                    .url("https://ubicate-smov.firebaseio.com/")
                    .build();
        ...
        if (mUriMatcher.match(uri) == TYPE_ALL_SUGGESTIONS) {
            ...
            String city = users.get(position);
